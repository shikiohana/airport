...
public class NotPlanWorkAdapter extends RecyclerView.Adapter{
    ...
    Context context;
    List<NotPlanOrder.DataBean> list;
    ...
    public NotPlanWorkAdapter(Context context, List<NotPlanOrder.DataBean> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if(list.size()==0){
            ...
            orderHolder.orderContent.setText(dataBean.getDoContentS());
