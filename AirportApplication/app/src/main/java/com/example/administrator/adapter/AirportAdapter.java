...
public class AirportAdapter extends BaseAdapter {
    private List<AirportBasic.DataBean> list;
    private Context context;
    private LayoutInflater inflater;

    public AirportAdapter(Context context, List<AirportBasic.DataBean> list) {
        this.list = list;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        titleHolder.textView.setText(list.get(i).getPointName());
        return view;
    }
